...
public class PesquisarActivity extends AppCompatActivity {
    ...
    // Quem pesquisa tem 20 segundos para executar a ação
    // Não consegui implementar de forma diferente
    public void contentAllContas() {
        getAllContas(20000);
    }

    // Exibir uma lista de contas baseado na pesquisa e tipo selecionados
    public void contentlist(String pesquisa, int tipo) {
        getListContas(1000, pesquisa, tipo);
    }

    // Obter todas as contas a cada 'miliseconds' em milissegundos
