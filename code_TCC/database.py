...
def parse_base(data):
    ...
    start_index = data.find("base {\n  ") + len("base {\n  ")
    end_index = data.find("\n}", start_index)
    base_data = data[start_index:end_index]
    base_dict = {}
...
# def parse_actuators(data):
#     actuators_data = []
#     start_index = data.find("actuators {")
#     while start_index != -1:
#         end_index = data.find("}", start_index) + 1
#         actuators_data.append(data[start_index:end_index].strip())
#         start_index = data.find("actuators {", end_index)
#     actuators_dict = []
#     for actuator_data in actuators_data:
#         actuator_dict = {}
#         lines = actuator_data.split("\n")
#         for line in lines:
#             if line.strip():
#                 key, value = line.split(":")
#                 actuator_dict[key.strip()] = value.strip()
#         actuators_dict.append(actuator_dict)
...
base_data_dict = parse_base(json_string)
# actuators_data_dict = parse_actuators(json_string)
