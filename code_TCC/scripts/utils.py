...
sequence = [f'movement_2_safe_grasp', f'movement_3_grasp', f'movement_2_safe_grasp', f'movement_4_safe_release', f'movement_5_release', f'movement_4_safe_release', 'Home']

movements = {f'movement {i + 1}': sequence[i] for i in range(7)}
